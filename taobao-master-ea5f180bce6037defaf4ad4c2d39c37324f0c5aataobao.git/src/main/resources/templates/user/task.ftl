...
<div class="container-fluid" id="app">
    <div class="row" style="margin-top: 15px">
        ...
        <div class="col-6">
            <a href="/taoshelf/task_add/task1_add" class="btn btn-primary float-right">创建任务</a>
        </div>
    </div>
    <#if info?exists>
        ...
        <table class="table table-hover table-sm">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="/taoshelf/tasklog/getTaskLogByTaskIdPage?taskId=${task.id}" class="btn  btn-sm  btn-primary">任务日志</a>
                </td>
            </tr>
            </#list>
            </tbody>
