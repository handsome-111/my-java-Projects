...
<div class="container" id="app">
    <form method="post" action="/taoshelf/add_task2">
        ...
        <div class="row" style="margin-top: 15px">
            <div class="col-12">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a href="/taoshelf/task_add/task2_add" class="nav-link active">完整上下架</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="row" style="margin-top: 15px">
            <div class="col-12">
                <div class="alert alert-success alert-dismissable">
                    ...
                    <strong>完整上下架</strong> ：指定任务开始时间，系统将对用户在售或库存商品进行一次完整上下架，不能有正在执行或待执行的其他任务在本任务的开始时间之后，一次只能设置一个完整上下架任务
                </div>
            </div>
        </div>
        <div class="row" style="margin-top: 15px">
