...
<div class="container" id="app">
    <form method="post" action="/taoshelf/startGoodsDelistingTask">
        ...
        <div class="row" style="margin-top: 15px">
            <div class="col-12">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a href="/taoshelf/task_add/task3_add" class="nav-link">完整上架</a>
                    </li>
                    <li class="nav-item">
                        <a href="/taoshelf/task_add/task4_add" class="nav-link active">完整下架</a>
                    </li>
                </ul>
            </div>
        </div>
        <div class="row" style="margin-top: 15px">
            <div class="col-12">
                <div class="alert alert-success alert-dismissable">
                    ...
                    <strong>完整下架</strong> ：指定任务开始时间，在售商品进行一次完整下架，不能有正在执行或待执行的其他任务在本任务的开始时间之后，一次只能设置一个完整下架任务
                </div>
            </div>
        </div>
        <div class="row" style="margin-top: 15px">
