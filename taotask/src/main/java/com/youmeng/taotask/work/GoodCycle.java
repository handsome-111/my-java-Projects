...
public class GoodCycle {
	...
	private Thread secondTask;	//第二个任务
	private Thread thirdlyTask;	//第三个任务，即更新接口
    ...
    public GoodCycle(String taskId){
    	this.taskId = taskId;
    }
	...
	public void firstTask(){
		firstTask = new Thread(new GoodCycleFirstTask(this));
		firstTask.start();
	}
	/**
	 * 第二个任务：
	...
	public void secondTask(){
		secondTask = new Thread(new GoodCycleSecondTask(this));
		secondTask.start();
	}
	/**
	 * 第三个任务：
	 * 负责使用更新接口来处理上下架
	 */
	public void thirdlyTask(){
		thirdlyTask = new Thread(new GoodUpdateInterface(this));
		thirdlyTask.start();
	}
	
	/**
	 * 中止任务,由firstTask发起，中止其他任务
	 */
	public void breakDown(){
		secondTask.interrupt(); 	//中止第二级任务,因为该任务会堵塞，其他任务则会自己死亡
	}
	/**
	 * 用时
	 */
